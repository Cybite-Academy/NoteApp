        ...
        <div>
            {noteDetails.length > 0 ? (
                noteDetails.map(note => (
                    <div key={note.title} className="flex flex-col gap-3 border border-black p-6 rounded-lg">
                        ...
                        <span className="w-fit text-[10px] text-black bg-slate-200 py-1 px-2 rounded-full">{note.noteTag}</span>
                    </div>
                ))
            ) : (
